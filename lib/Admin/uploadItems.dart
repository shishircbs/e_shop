...
bool uploading=false;
  ...
  Widget build(BuildContext context) {
    return file==null?displayAdminScreen():displayAdminUploadFormScreen();
  }
  ...
  displayAdminUploadFormScreen(){
    return Scaffold(
      appBar: AppBar(flexibleSpace: Container(
        ...
        actions: [
          FlatButton(onPressed: ()=>print("clicked"), child: Text("Add", style: TextStyle(color: Colors.pink, fontSize: 16.0, fontWeight: FontWeight.bold),))
        ],
      ),
      body: ListView(
        children: [uploading?linearProgress():Text(""),
        ...
        width: MediaQuery.of(context).size.width*0.8,
          ...
          Divider(color: Colors.pink,),ListTile(
            leading: Icon(Icons.perm_device_information, color: Colors.pink,),
            title: Container(
              width: 250.0,
              child: TextField(
