...
void checkItemInCart(String shortInfoAsID, BuildContext context) {
  EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList)
      .contains(shortInfoAsID) ? Fluttertoast.showToast(
      msg: "Item is already in Cart") : addItemToCart(shortInfoAsID, context);
}
...
addItemToCart(String shortInfoAsID, BuildContext context) {
  ...
  EcommerceApp.firestore.collection(EcommerceApp.collectionUser).document(
      EcommerceApp.userUID).updateData(
      {EcommerceApp.userCartList: tempCartList}).then((v) {
